package com.cesurg.enchentes.Security;

import com.cesurg.enchentes.Security.Jwt.AuthEntryPointJwt;
import com.cesurg.enchentes.Security.Jwt.AuthFilterToken;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth.requestMatchers("/auth/**").permitAll()
                        ...
                        .requestMatchers("/historico/listar").hasAnyRole("ENGENHARIA", "ADMIN")
